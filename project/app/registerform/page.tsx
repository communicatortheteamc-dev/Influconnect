...
export default function Page() {
    const [form, setForm] = useState<any>({
        ...
        youtube: { username: '', followers: '', profileLink: '', frequency: '', rating: '', influBudget: '', budget: {} },
    ...
    async function handleSave(e: React.FormEvent) {
        ...
        const payload = {
            ...
            youtube: normalize(form.youtube),
            ...
            <div className="w-full max-w-4xl bg-white rounded-lg shadow p-6">
                ...
                <form className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="md:col-span-3">
                        ...
                        <PlatformCard name="YouTube" path="youtube" form={form} updatePath={updatePath} />
